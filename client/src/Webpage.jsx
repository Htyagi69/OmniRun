...
function Website({socket}){
  ...
  return (
    ...
    <button onClick={()=>setIsClicked(true)} className={`flex w-full m-2 bg-blue-400  p-2 font-bold justify-center rounded-sm mr-2 ${isClicked ? 'bg-white text-black':' bg-blue-400 text-white'}`}>Build code</button>
    </div>
    <div className='flex'>
         <Files socket={socket} setCode={setCode} code={code}/>
